        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 relative">
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl">
              <div className="aspect-[4/5] bg-slate-200 dark:bg-slate-800 relative group">
                ...
                <img 
                  src="/about-me.jpeg" 
                  alt="Portrait of Nursyasya Aina" 
          ...
          <div className="lg:col-span-7 space-y-8">
            <div>
              ...
              <div className="prose prose-lg dark:prose-invert">
                <p className="text-slate-600 dark:text-slate-300 text-lg leading-relaxed mb-6 font-serif">
                  Hello! I'm a passionate final-year student from <strong>Universiti Utara Malaysia</strong> currently pursuing a Bachelor in Computer Science, majoring in <span className="text-indigo-600 dark:text-indigo-400 font-medium italic">Human-Centered Computing</span>.
                </p>
            ...
            <div className="flex gap-4 pt-4">
              <a
                href="/Nursyasya_Aina_Resume.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-widest border-b-2 border-slate-900 dark:border-white pb-1 hover:text-indigo-600 hover:border-indigo-600 transition-colors"
              >
